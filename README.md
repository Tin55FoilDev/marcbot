...
Current baseline: **MarcBot 0.3.39**.
...
MarcBot 0.3.39 enables provider-contacting `source-monitor-ai-summary` execution from Telegram after validated confirmation tokens, using the fixed safe adapter.
