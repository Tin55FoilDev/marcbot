...
Current baseline: **MarcBot 0.3.28**.
...
MarcBot 0.3.28 adds Telegram provider-contact preflight for `/workflow_run source-monitor-ai-summary`, while keeping the provider-contacting summary workflow CLI-only.
