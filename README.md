...
Current baseline: **MarcBot 0.3.10**.
...
MarcBot 0.3.10 hardens provider-contact LLM CLI commands by loading the local LLM environment file before contacting configured providers.
