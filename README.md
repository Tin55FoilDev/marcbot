...
Current baseline: **MarcBot 0.3.40**.
...
MarcBot 0.3.40 hardens Telegram summary execution prompt budgeting by disabling memory-context expansion in the fixed provider-contact adapter.
