...
Current baseline: **MarcBot 0.3.33**.
...
MarcBot 0.3.33 documents the final provider-contact execution-enablement gate for `/workflow_confirm`, while keeping provider-contacting summary execution disabled.
