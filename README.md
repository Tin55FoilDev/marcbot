...
Current baseline: **MarcBot 0.3.38**.
...
MarcBot 0.3.38 adds a Telegram-safe source-monitor summary execution adapter, while keeping provider-contacting Telegram execution disabled.
