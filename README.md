...
Current baseline: **MarcBot 0.3.24**.
...
MarcBot 0.3.24 adds read-only Telegram `/workflow_artifacts <workflow-id>` visibility, while keeping workflow execution and file sending absent.
