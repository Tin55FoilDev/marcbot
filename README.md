...
Current baseline: **MarcBot 0.3.13**.
...
MarcBot 0.3.13 adds the `source-monitor` memory context profile and provider-contact-free source-monitor summary prompt preview.
