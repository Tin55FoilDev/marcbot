...
Current baseline: **MarcBot 0.3.18**.
...
MarcBot 0.3.18 adds controlled candidate-to-pending-proposal bridges for CLI and Telegram while preserving the durable-memory approval boundary.
