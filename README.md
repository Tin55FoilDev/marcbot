...
Current baseline: **MarcBot 0.3.22**.
...
MarcBot 0.3.22 fixes Telegram `/workflow_status <workflow-id>` delivery by matching the workflow status formatter signature, while keeping workflow execution CLI-only.
