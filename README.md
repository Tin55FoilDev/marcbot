...
Current baseline: **MarcBot 0.3.21**.
...
MarcBot 0.3.21 adds read-only Telegram workflow visibility with `/workflow_list` and `/workflow_status <workflow-id>`, while keeping workflow execution CLI-only.
