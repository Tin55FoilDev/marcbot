...
Current baseline: **MarcBot 0.3.9**.
...
MarcBot 0.3.9 adds opt-in memory context for LLM file summarization, with live validation and documented LM Studio environment handling.
