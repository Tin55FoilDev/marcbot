...
Current baseline: **MarcBot 0.3.23**.
...
MarcBot 0.3.23 adds CLI-only workflow artifact visibility with `workflow artifacts`, while keeping Telegram workflow execution absent.
