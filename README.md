...
Current baseline: **MarcBot 0.3.15**.
...
MarcBot 0.3.15 adds `/memory_propose_fact`, the first Telegram-side memory write path, creating pending proposals without approving durable facts.
