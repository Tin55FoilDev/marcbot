...
Current baseline: **MarcBot 0.3.6**.
...
MarcBot 0.3.6 adds the first SQLite-backed read/query command for local memory facts while keeping file memory as the source of truth.
