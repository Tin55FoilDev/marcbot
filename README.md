...
Current baseline: **MarcBot 0.3.32**.
...
MarcBot 0.3.32 validates `/workflow_confirm` confirmation tokens end-to-end, while keeping provider-contacting summary execution disabled.
