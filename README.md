...
Current baseline: **MarcBot 0.3.20**.
...
MarcBot 0.3.20 adds controlled candidate memory writes for pending fact proposals and low-risk operational events, with JSON contracts and validated SQLite sync.
